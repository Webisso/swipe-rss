...
- Una URL para la lista completa de feeds; no hace falta añadir feeds uno a uno.

## Contribuir

Nuevos feeds y categorías son bienvenidos. Abre un **Pull Request** para añadir o sugerir cambios.

- Añade feeds en la categoría y sección de idioma correctas en `feeds.opml`.
...
- **.github/workflows/** — Automatización (ej. comprobaciones de feeds).
